            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex space-x-8">
                    ...
                    <div class="hidden md:flex space-x-6 items-center">
                        ...
                        <a href="{{ route('admin.spk.history') }}" class="...">
    Riwayat Penempatan
</a>
                        <a href="{{ route('admin.criterias.index') }}" 
   class="flex items-center gap-3 px-4 py-2.5 text-sm font-extrabold rounded-xl transition duration-150 
   {{ request()->routeIs('admin.criterias.index') 
      ? 'bg-indigo-50 text-indigo-600 border border-indigo-100' 
      : 'text-gray-700 hover:bg-gray-50' }}">
    
    <span class="text-base leading-none">⚖️</span>
    <span>Bobot Kriteria SMART</span>
</a>
                    </div>
                </div>
                <div>
